...
Route::prefix('profile')->group(function(){
    ...
    Route::get('disableproduct/{turn}', 'ProfileController@disableProduct') -> name('profile.disableproduct'); // change 2fa

    Route::get('verifyAddress/{verifyAddress}', 'VendorController@verifyAddress') -> name('profile.verifyAddress'); // change 2fa
