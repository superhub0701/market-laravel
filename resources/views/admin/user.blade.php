                ...
                <div class="column">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="empire" id="empire" class="form-control" value="{{$user->empire_feedback}}" oninput="return checkValidFeedbackNo(this);">
                        </div>

                        <div class="form-group">
                            <label for="whm">WHM:</label>
                            <input type="text" name="whm" id="whm" class="form-control" value="{{$user->whm_feedback}}" oninput="return checkValidFeedbackNo(this);">
                                   
                        </div>
						<div class="form-group">
                            <label for="dream">Dream:</label>
                            <input type="text" name="dream" id="dream" class="form-control" value="{{$user->dream_feedback}}" oninput="return checkValidFeedbackNo(this);">
                                   
                        </div>

                        <div class="form-group">
                            <label for="darkfox">Darkmarket:</label>
                            <input type="text" name="darkmarket" id="darkmarket" class="form-control" value="{{$user->darkmarket_feedback}}" oninput="return checkValidFeedbackNo(this);">
                                   
                        </div>
						<div class="form-group">
                            <label for="darkfox">Versus:</label>
                            <input type="text" name="versus" id="versus" class="form-control" value="{{$user->versus_feedback}}" oninput="return checkValidFeedbackNo(this);">
                                   
                        </div>
						<div class="form-group">
                            <label for="darkfox">Berlusconi:</label>
                            <input type="text" name="berlusconi" id="berlusconi" class="form-control" value="{{$user->berlusconi_feedback}}" oninput="return checkValidFeedbackNo(this);">
...
function checkValidFeedbackNo(obj){	
	var regexp = /[^0-9\/]/g;
	var value = obj.value;
	
	if(value != '' && regexp.test(value)){			
		obj.value = value.replace(regexp,''); 
	}
	return false;
}
</script>
