                ...
                <div class="col-md-12 text-center">
                    ...
                    <table class="table border-0 text-left table-borderless">
                        ...
                        @if($product->user->vendor->canUseFe() || $product->user->vendor->isTrusted())
                                    <p class="badge badge-success">Trusted vendor <img src="/img/star15.ico"/></p>
                @endif
                        <tr>
        ...
        <div class="col-md-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                        <a href="{{ route('profile.messages').'?otherParty='.$product -> user ->username}}" class="btn mb-1 btn-outline-secondary"><img src="/img/envelope.ico"> Send message</a>
