<div class="col-md-6">
    ...
    <table class="table ">
        ...
        <tr>
        {{ $base_string = base64_encode($purchase->address) }}
        <a href="{{ route('profile.verifyAddress',$base_string) }}" target="_blank"
                           class="btn btn-outline-success">Verify Payment Address</a>
            <td>Address:</td>
